...
before_adjectives = ["Mighty", "Fearless", "Cunning", "Noble", "Valiant", "Daring", "Gallant", "Heroic"]

all_combinations = list(product(before_adjectives, adjectives, name_first, name_last))
