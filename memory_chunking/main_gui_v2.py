...
class MemoryChunkingGame:
    def __init__(self, root):
        ...
        # Ready button
        self.ready_button = tk.Button(self.root, text="Ready", font=("Arial", 12),
                                      command=self.ready_to_input, state=tk.DISABLED)
    ...
    def ready_to_input(self):
        """Hide the chunk and enable input after Ready button is clicked"""
